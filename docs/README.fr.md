...
- 🎛️ **Groupes d'actions** — regroupe une série d'actions dans un groupe réutilisable (Concentration / Réunion / Clôture / Coucher…) et déclenche-le d'un clic depuis la barre d'état système, la liste de démarrage ou un rappel. Modèles intégrés inclus.
...
Il s'agit du projet #20 du [Plan Open Source 365](https://github.com/rockbenben/365opensource) — une personne + l'IA, plus de 300 projets open source en un an. [Soumettre une demande →](https://my.feishu.cn/share/base/form/shrcnI6y7rrmlSjbzkYXh6sjmzb)

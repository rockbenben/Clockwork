...
- 🔌 **Puertos** — cada puerto TCP en escucha junto al proceso que lo ocupa: haz doble clic en una fila para abrir `localhost:3000` en el navegador y clic derecho para finalizar ese proceso junto con sus procesos secundarios. Útil para dar con el servidor de desarrollo que olvidaste cerrar; los servicios del sistema quedan ocultos de forma predeterminada.

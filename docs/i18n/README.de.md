...
- 🔌 **Ports** — jeder TCP-Port, auf dem gerade gelauscht wird, samt dem Prozess, der ihn hält: Doppelklick auf eine Zeile öffnet `localhost:3000` im Browser, Rechtsklick beendet den Prozess mitsamt seinen Unterprozessen. Praktisch, um den vergessenen Dev-Server wiederzufinden; Systemdienste bleiben standardmäßig ausgeblendet.

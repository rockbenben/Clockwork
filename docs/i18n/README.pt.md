...
- 🔌 **Portas** — cada porta TCP em escuta ao lado do processo que a ocupa: clique duas vezes em uma linha para abrir `localhost:3000` no navegador e, com o botão direito, encerre esse processo junto com os processos filhos. Útil para achar o dev server que você esqueceu de fechar; serviços do sistema ficam ocultos por padrão.

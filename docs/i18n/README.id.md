...
- 🔌 **Port** — setiap port TCP yang sedang didengarkan beserta proses yang memakainya: klik ganda sebuah baris untuk membuka `localhost:3000` di peramban, klik kanan untuk mengakhiri proses itu beserta proses anaknya. Praktis untuk menemukan dev server yang lupa Anda tutup; layanan sistem tersembunyi secara bawaan.
